...
export default function Registration() {
    ...
    const onSubmit = async (data) => {
        ...
        const role = submitData.userType || 'TYPE_CLIENT';
        const endpoint = role === 'TYPE_COURIER' ? '/auth/courier_signup' : '/auth/client_signup';
        try {
            ...
            if (err?.response) {
                ...
                alert(body?.message || statusText || `Ошибка регистрации: ${status}`);
            } else if (err?.request) {
